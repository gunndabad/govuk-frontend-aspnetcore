...
public class TitleTagHelperTests
{
    ...
    public async Task ProcessAsync_GeneratesExpectedOutput(bool pageHasErrors, bool expectErrorInTitle)
    {
        // Arrange
        ...
        var tagHelper = new TitleTagHelper() { ErrorPrefix = "Error:", ViewContext = viewContext };
