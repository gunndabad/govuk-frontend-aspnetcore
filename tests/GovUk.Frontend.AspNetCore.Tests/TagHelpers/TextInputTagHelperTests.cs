...
public class TextInputTagHelperTests
{
    ...
    public async Task ProcessAsync_InvokesComponentGeneratorWithExpectedOptions()
    {
        ...
        componentGeneratorMock
            .Setup(mock => mock.GenerateTextInput(It.IsAny<TextInputOptions>()))
            .Callback<TextInputOptions>(o => actualOptions = o);
    ...
    public async Task ProcessAsync_WithErrorMessage_GeneratesOptionsWithErrorMessageAndAddsErrorClasses()
    {
        ...
        Assert.Collection(
            actualOptions.ErrorMessage.Attributes,
            kvp =>
            {
                Assert.Equal("data-foo", kvp.Key);
    ...
    public async Task ProcessAsync_WithFor_GeneratesOptionsFromModelMetadata()
    {
        ...
        modelHelperMock
            .Setup(mock =>
                mock.GetDescription( /*modelExplorer: */
    ...
    public async Task ProcessAsync_WithError_AddsErrorWithCorrectFieldIdToContainerErrorContext()
    {
        ...
        var context = new TagHelperContext(
            tagName: "govuk-input",
            allAttributes: new TagHelperAttributeList(),
            items: new Dictionary<object, object>() { { typeof(ContainerErrorContext), formErrorContext } },
            uniqueId: "test"
        );
