...
public class DateOnlyDateInputModelConverterTests
{
    ...
    public void CreateDateFromComponents_ReturnsExpectedResult(Type modelType, DateOnly date, object expectedResult)
    {
        // Arrange
    ...
    public static TheoryData<Type, DateOnly, object> CreateDateFromElementsData { get; } =
        new()
        {
