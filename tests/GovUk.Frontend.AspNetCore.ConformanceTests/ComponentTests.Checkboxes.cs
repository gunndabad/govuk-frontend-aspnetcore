...
{
    [Theory]
    [ComponentFixtureData("checkboxes", typeof(OptionsJson.Checkboxes), exclude: "with falsey values")]
                                ...
                                new CheckboxesItem()
                                {
                                    Behavior =
                                        item.Behaviour == "exclusive"
                                            ? CheckboxesItemBehavior.Exclusive
                                            : CheckboxesItemBehavior.Default,
                                    Conditional =
                                    ...
                                    Checked =
                                        item.Checked
                                        ?? (options.Values?.Contains(item.Value) == true ? (bool?)true : null)
