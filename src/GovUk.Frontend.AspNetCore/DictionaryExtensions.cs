...
internal static class DictionaryExtensions
{
        ...
        where TKey : notnull
    {
        return dict is not null
            ? ImmutableDictionary.ToImmutableDictionary(dict)
            : ImmutableDictionary<TKey, TValue>.Empty;
    }

    public static ImmutableDictionary<TKey, TValue> AddIf<TKey, TValue>(
    ...
    public static ImmutableDictionary<TKey, TValue> AddIfNotNull<TKey, TValue>(
        this ImmutableDictionary<TKey, TValue> dict,
        TKey key,
        TValue value
    )
    ...
    public static ImmutableDictionary<TKey, TValue> Remove<TKey, TValue>(
        this ImmutableDictionary<TKey, TValue> dict,
        TKey key,
        out TValue? value
    )
