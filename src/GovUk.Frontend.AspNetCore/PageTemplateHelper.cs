...
public class PageTemplateHelper
{
    ...
    public IHtmlContent GenerateScriptImports(string? cspNonce = null)
    {
        ...
        {
            var tagBuilder = new TagBuilder("script");
            tagBuilder.MergeAttribute("src", "/govuk-frontend-4.5.0.min.js");
            return tagBuilder;
        }
    ...
    <link rel=""stylesheet"" href=""/govuk-frontend-4.5.0.min.css"">
<!--<![endif]-->
<!--[if IE 8]>
    <link rel = ""stylesheet"" href=""/govuk-frontend-ie8-4.5.0.min.css"">
<![endif]-->");
