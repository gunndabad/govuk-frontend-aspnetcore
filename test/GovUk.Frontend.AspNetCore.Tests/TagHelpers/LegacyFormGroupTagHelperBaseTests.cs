...
{
    public class LegacyFormGroupTagHelperBaseTests
    {
        [Fact]
        public async Task ProcessAsync_NoNameOrAspForThrowsInvalidOperationException()
        {
            ...
            var tagHelper = new TestFormGroupTagHelper(new ComponentGenerator(), new DefaultModelHelper())
            {
                Id = "my-element-id"
            };
        ...
        public async Task ProcessAsync_NonNullIdUsesSpecifiedId()
        {
            ...
            var tagHelper = new TestFormGroupTagHelper(new ComponentGenerator(), modelHelperMock.Object)
            {
                Id = "my-element-id",
    ...
    public class FormGroupBuilderTests
    {
        [Fact]
    ...
    public class TestFormGroupTagHelper : LegacyFormGroupTagHelperBase
    {
